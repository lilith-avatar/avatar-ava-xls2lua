...
TRANSLATE_XLS = 'LanguagePack.xlsx'
...
LUA, COMMENT, LANG = 'lua', 'comment', 'lang'
        ...
        for row_idx in range(row_idx, sheet.nrows):
            ...
            for col_idx in range(sheet.ncols):
                ...
                if type_dict[title] == INT and vtype == xlrd.XL_CELL_NUMBER:
                    ...
                    v = 'true' if value == 1 else 'false'
                elif type_dict[title] == LANG and vtype == xlrd.XL_CELL_TEXT:
                    v = str(value)
            ...
            for k, v in lang_kv.items():
                lang_key = v + lang_suffix
                g_lang_kv[lang_key] = row[k]
                row[k] = lang_key
